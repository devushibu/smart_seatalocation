  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 pt-4">
      ...
      <Card className="glass glow-card overflow-hidden border-slate-800 shadow-2xl relative bg-slate-950/40 rounded-3xl">
        ...
        <CardHeader className="bg-linear-to-r from-indigo-900/60 to-indigo-950/80 px-8 py-6 border-b border-indigo-500/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-3 w-full">
            <div className="bg-indigo-600 p-2.5 rounded-xl text-white shadow-lg shadow-indigo-600/25">
              <GraduationCap size={22} />
            </div>
            <div className="flex-1">
              <CardTitle className="text-lg text-white uppercase tracking-wide">
                Seating Arrangement
              </CardTitle>
              <CardDescription className="text-[10px] text-indigo-400 uppercase tracking-widest font-extrabold mt-0.5">
                Exam Seating Details
              </CardDescription>
            </div>
            <Badge
              variant="secondary"
              className="bg-indigo-500/20 text-indigo-350 border-indigo-550/20 hover:bg-indigo-500/30 uppercase tracking-wider font-bold"
            >
              Active Session
            </Badge>
          </div>
          ...
          {allocation && allocation.allocated ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
              ...
              <Card className="bg-slate-950/60 border-slate-850 flex items-center gap-4 p-5 rounded-2xl shadow-none">
                ...
                <div>
                  <span className="text-[10px] font-bold text-slate-500 tracking-widest block uppercase">
                    SEAT NUMBER
                  </span>
